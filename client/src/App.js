...
import { Button, Col, Row, ButtonToolbar, FormControl, FormGroup, ControlLabel, Form, Modal } from 'react-bootstrap';
import './App.css';
          ...
          response.json().then((response) => {
            switch (response.error) {
                ...
                case AUTH_CONSTANTS.EMAIL_ALREADY_IN_DB:
                  this.setState({
                    modal_title: 'Error',
                    modal_text: 'Email is already listed in database. Wait for teacher to approve it.'
                  })
                  break;
