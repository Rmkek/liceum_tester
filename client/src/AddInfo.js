...
import {Panel, Col, Button, FormControl, FormGroup, Modal,  ControlLabel} from 'react-bootstrap'
...
class AddInfo extends Component {
    ...
    closeModal = (e) => {this.setState({modal_shown: false})}

    submitAdditionalInfo = (e) => {
        if (this.state.full_name === '') {
            this.setState({modal_shown: true})
            this.setState({modal_title: 'Name is not defined.'})
            this.setState({modal_text: 'Add your full name to submit additional info.'}) 
        } else {
    ...
    render() {
        return (this.state.infoAdded ? <Redirect from="/add-info" to="/assignments"/> :
            <Col xs={4} xsOffset={4} className='info__container'>
                <div className="modal-container">
                    <Modal
                        ...
                        <Modal.Header closeButton>
                            <Modal.Title id="contained-modal-title">{this.state.modal_title}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                ...
                <Panel header='Additional information'>
                    ...
                    <FormControl className="add-info__fullname" type="email" 
                    ...
                    <ControlLabel className="info__grade__label">Select Grade:</ControlLabel>
                    <FormControl className="info__grade__select__grade" componentClass="select" placeholder="select">
                    ...
                    <ControlLabel className="info__grade__letter">Select Grade Letter:</ControlLabel>
                    <FormControl className="info__grade__select__letter" componentClass="select" placeholder="select">
                    ...
                    <Button onClick={this.submitAdditionalInfo} bsSize="large" bsStyle="primary">Submit</Button>
                </Panel>
            </Col>
    )
  }
